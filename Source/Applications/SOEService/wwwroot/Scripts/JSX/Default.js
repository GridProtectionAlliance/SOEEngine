...
var MainPage = (function (_super) {
    ...
    MainPage.prototype.tableCallback = function (rowData, column) {
        var _this = this;
        var level = '';
                        ...
                        React.createElement("div", { className: "panel-body" },
                            ...
                            React.createElement("div", { className: "col-md-4" },
                                React.createElement(BootstrapDateRangePicker_1.default, { formLabel: "Start Date:", startDate: moment(ctrl.state.date, 'YYYYMMDDHH'), singleDatePicker: true, showDropdowns: true, applyDateRangePicker: function (msg) {
                                        this.setState({ 'date': msg.date.format('YYYYMMDDHH') }, function () { return ctrl.history['push']('Summary.cshtml?' + queryString.stringify(ctrl.state)); });
                                    } }),
