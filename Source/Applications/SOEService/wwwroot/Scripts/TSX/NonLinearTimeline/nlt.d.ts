...
export interface MapMeter { AssetKey: string, Type: 'Substation CB' | 'N.C. PCR' | 'N.O. PCR', Latitude: number, Longitude: number, SourceAlternate: string, SourcePreferred: string, Voltage: number, Color: string, ColorText: string, Make: string }
