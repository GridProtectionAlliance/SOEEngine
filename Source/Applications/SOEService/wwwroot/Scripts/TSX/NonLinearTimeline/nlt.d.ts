...
export interface MapMeter { AssetKey: string, Latitude: number, Longitude: number, SourceAlternate: string, SourcePreferred: string, Voltage: number, Color: string, ColorText: string, Make: string }
