...
namespace WixFolderGen
{
    class Solution
    {
        ...
        public Solution(string projectName, string rootFolderName, string applicationFolder, string fileNamePostfix)
        {
            ...
            WebFeaturesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\SOESetup\\WebFeatures"+fileNamePostfix +".wxi";
            WebFoldersDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\SOESetup\\WebFolders" + fileNamePostfix + ".wxi";
            WebFilesDestinationFile = "..\\..\\..\\..\\..\\Source\\Applications\\SOESetup\\WebFiles" + fileNamePostfix + ".wxi";
        }
    ...
    class Program
    {
        static void Main()
        {
            ...
            {
                new Solution("SOEService", "wwwroot", "Applications", "")
