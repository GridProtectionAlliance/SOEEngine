...
namespace SOEDataProcessing.Database
{
	...
	public partial class Meter : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<Meter> _Meter1;
    ...
    partial void OnDescriptionChanging(string value);
    partial void OnDescriptionChanged();
    partial void OnPhasingChanging(string value);
    partial void OnPhasingChanged();
    ...
    partial void OnOrientationChanged();
		...
		public Meter()
		{
			...
			this._Meters = new EntitySet<Meter>(new Action<Meter>(this.attach_Meters), new Action<Meter>(this.detach_Meters));
			this._MeterLocation = default(EntityRef<MeterLocation>);
			this._Meter1 = default(EntityRef<Meter>);
			OnCreated();
		}
		...
		public System.Nullable<int> ParentID
		{
			...
			set
			{
				...
				{
					if (this._Meter1.HasLoadedOrAssignedValue)
					{
						throw new System.Data.Linq.ForeignKeyReferenceAlreadyHasValueException();
					}
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Phasing", DbType="Char(3)")]
		public string Phasing
		{
			get
			{
			...
			set
			{
				if ((this._Phasing != value))
				{
					this.OnPhasingChanging(value);
					this.SendPropertyChanging();
					this._Phasing = value;
					this.SendPropertyChanged("Phasing");
					this.OnPhasingChanged();
				}
			}
		}
		
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Orientation", DbType="Char(2)")]
		...
		public Meter Parent
		{
			get
			{
				return this._Meter1.Entity;
			}
			set
			{
				Meter previousValue = this._Meter1.Entity;
				if (((previousValue != value) 
							|| (this._Meter1.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
