...
namespace SOEDataProcessing.Database
{
    ...
    partial void OnFilePathHashChanging(int value);
    partial void OnFilePathHashChanged();
    ...
    partial void OnLastAccessTimeChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_FilePathHash", DbType="Int NOT NULL")]
		public int FilePathHash
		{
			get
			{
				return this._FilePathHash;
			}
			set
			{
				if ((this._FilePathHash != value))
				{
					this.OnFilePathHashChanging(value);
					this.SendPropertyChanging();
					this._FilePathHash = value;
					this.SendPropertyChanged("FilePathHash");
					this.OnFilePathHashChanged();
				}
			}
		}
