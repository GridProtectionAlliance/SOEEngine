...
namespace FaultData.DataResources
{
    public class CycleDataResource : DataResourceBase<MeterDataSet>
    {
        ...
        private Series GetSeriesInfo(Meter meter, DataGroup dataGroup, string phaseName)
        {
            ...
            channelKey = new ChannelKey(dataGroup.Line.ID, 0, 0, channelName, measurementTypeName, measurementCharacteristicName, phaseName);
            seriesKey = new SeriesKey(channelKey, seriesTypeName);

            return GetSeriesInfo(meter, channelKey, seriesKey);
        }
