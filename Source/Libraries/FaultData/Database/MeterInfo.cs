...
namespace FaultData.Database
{
    public class ChannelKey : IEquatable<ChannelKey>
    {
        ...
        public ChannelKey(int lineID, int loadSide, int harmonicGroup, string name, string measurementType, string measurementCharacteristic, string phase)
        {
            m_tuple = Tuple.Create(lineID, loadSide, harmonicGroup, name, measurementType, measurementCharacteristic, phase);
        }

        public ChannelKey(Channel channel)
            : this(channel.Line.ID, channel.LoadSide, channel.HarmonicGroup, channel.Name, channel.MeasurementType.Name, channel.MeasurementCharacteristic.Name, channel.Phase.Name)
        {
        }
